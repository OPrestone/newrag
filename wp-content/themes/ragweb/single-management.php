<?php get_header();  
// Check if we have management posts
if (have_posts()) {
    ...
    while (have_posts()) {
        ...
        $phone = get_post_meta(get_the_ID(), '_management_phone', true);
        $email = get_post_meta(get_the_ID(), '_management_email', true);
        $address = get_post_meta(get_the_ID(), '_management_address', true);
