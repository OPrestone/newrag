                    ...
                    <div class="blog__details-wrap">
                        ...
                        <div class="blog__details-content">
                            ...
                            <div class="blog-post-meta">
                                <ul class="list-wrap">
                                    ...
                                    <li><i class="fas fa-calendar-alt"></i><?php echo get_the_date(); ?>
                                    </li>
                                    <li><i class="far fa-comment"></i><a href='@'>
                                            <?php echo get_comments_number_text('0 Comments', '1 Comment', '% Comments'); ?>
                                        </a></li>
                                </ul>
                                    ...
                                    <div class="col-md-5">
                                        <div class="post-share">
                                            ...
                                            <ul class="list-wrap">
                                                ...
                                                <li><a
                                                        href="https://twitter.com/share?url=<?php the_permalink(); ?>&text=<?php echo rawurlencode(get_the_title()); ?>"><i
                                                            class="fab fa-twitter"></i></a></li>
                                                <li><a
                                                        href="https://api.whatsapp.com/send?text=<?php echo rawurlencode(get_the_title() . ' - ' . get_the_permalink()); ?>"><i
                                                            class="fab fa-whatsapp"></i></a></li>
                                                <li><a
                                                        href="https://www.linkedin.com/shareArticle?url=<?php the_permalink(); ?>&title=<?php the_title(); ?>"><i
                        ...
                        <div class="blog__avatar-wrap mb-60">
                            <div class="blog__avatar-img">
                                <a href="<?php echo get_author_posts_url($author_id); ?>"><img
                                        src="<?php echo $author_avatar; ?>"
                                        alt="<?php echo esc_attr($author_name); ?>"></a>
                            </div>
                            <div class="blog__avatar-info">
                                <span class="designation">Author</span>
                                <h4 class="name"><a href="<?php echo get_author_posts_url($author_id); ?>">
                            ...
                            <div class="sidebar__cat-list">
                                <ul class="list-wrap">
                                    ...
                                    foreach ($categories as $category):
                                        ?>
                                        <li>
                                            <a href="<?php echo esc_url(get_category_link($category->term_id)); ?>"><i
                                                    class="flaticon-arrow-button"></i>
                                    ...
                                    while ($latest_posts->have_posts()):
                                        ...
                                        <div class="sidebar__post-item">
                                            ...
                                            <div class="sidebar__post-content">
                                                ...
                                                <small class="small"><i class="flaticon-time"></i>
                                                    <?php echo get_the_date('M d, Y'); ?></small>
                                            </div>
                                        </div>
                                        <?php
                                    endwhile;
