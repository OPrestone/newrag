		 ...
		 <div class="typepart gpt3" style="display:none">
			...
			<div class="field f_100">
					...
					<div id="article_generation_prompt_cnt" class="field  ">
							...
							<textarea name="cg_gp_prompt" placeholder="Write an article about [article_title]" ><?php    echo wp_automatic_htmlentities(@$camp_general['cg_gp_prompt'],ENT_COMPAT, 'UTF-8')   ?></textarea>
