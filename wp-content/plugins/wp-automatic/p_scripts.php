...
function wp_automatic_admin_scripts()
{
	...
	if ('wp_automatic' == $post_type)
	{
		...
		wp_enqueue_script('wp_automatic_main_script', plugins_url('js/main.js', __FILE__), array(), '1.10.9');

		//enqueue tutorial script
		wp_enqueue_script('wp_automatic_tutorial_script', plugins_url('js/tutorials.js', __FILE__), array(), '1.0.16');
